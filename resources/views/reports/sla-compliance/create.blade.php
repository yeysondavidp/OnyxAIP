<x-layouts.app title="SLA Compliance Report">
    ...
    <x-slot:breadcrumbs>
        ...
        <span style="font-size: var(--fs-14); font-weight: var(--weight-medium); color: var(--text-primary);">SLA Compliance</span>
    </x-slot:breadcrumbs>

    <div style="max-width: 560px;">
        <div style="margin-bottom: var(--space-6);">
            <h1 style="font-size: var(--fs-24); font-weight: var(--weight-bold); color: var(--text-primary); margin-bottom: var(--space-1);">SLA Compliance</h1>
            <p style="font-size: var(--fs-14); color: var(--text-secondary);">Job-by-job SLA outcome for a client over a date range (CSV).</p>
        </div>

        <x-onyx.card variant="default" padding="xl">
            <form method="POST" action="{{ route('reports.sla-compliance.store') }}" novalidate>
                @csrf
