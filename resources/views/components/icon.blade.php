{{--
  Inline SVG icon from the Feather icon set (stroke icons, 24px viewBox).
  Only the icons actually used in the app are included here to keep the
  bundle lean. Add new icons as needed.

  Props:
    name  string — icon name (e.g. "grid", "briefcase")
    size  int    — px size     (default: 20)

  Usage:
    <x-icon name="monitor" size="16" />
--}}
...
$icons = [
    ...
    'qr-code' => '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="3" height="3"/><line x1="20" y1="17" x2="20" y2="20"/><line x1="17" y1="20" x2="20" y2="20"/>',
];
