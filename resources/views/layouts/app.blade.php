...
<head>
    ...
    <title>{{ isset($title) ? $title . ' — ONYX AIP' : 'ONYX Asset Intelligence Platform' }}</title>
...
{{-- ================================================================
     PM Shell: fixed left sidebar + scrollable main content area
     ================================================================ --}}
<div class="flex h-full">
    ...
    <aside
        id="sidebar"
        style="width: 240px; flex-shrink: 0; background: var(--onyx-900); color: var(--onyx-50); display: flex; flex-direction: column; position: fixed; inset-block: 0; left: 0; z-index: 40;"
    >
        {{-- Logo --}}
        ...
        <nav style="flex: 1; overflow-y: auto; padding: var(--space-4) 0;" aria-label="Main navigation">
            ...
            <x-layouts.nav-item route="dashboard" icon="grid">
                Dashboard
            </x-layouts.nav-item>
            <x-layouts.nav-item route="clients.index" icon="briefcase">
                Clients
            </x-layouts.nav-item>
            <x-layouts.nav-item route="stores.index" icon="map-pin">
                Stores
            </x-layouts.nav-item>
            ...
            <x-layouts.nav-item route="assets.index" icon="monitor">
                Asset Registry
            </x-layouts.nav-item>
            ...
            <x-layouts.nav-item route="jobs.index" icon="tool">
                Service Jobs
            </x-layouts.nav-item>
            <x-layouts.nav-item route="technicians.index" icon="users">
                Technicians
            </x-layouts.nav-item>
            ...
            <x-layouts.nav-item route="reports.index" icon="bar-chart-2">
                Reports
            </x-layouts.nav-item>
